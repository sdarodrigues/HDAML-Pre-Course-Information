...
*Note:* The images below refer to previous versions but the installation steps will be similar for the latest version.

<div class="figure">
<img src="FIG_software_installation/R_download_mac.png" alt="Downloading R from the CRAN" width="100%" />
<p class="caption">(\#fig:downloadR-label)Downloading R from the CRAN</p>
</div>
...
<p class="caption">(\#fig:installR-label)R installation</p>
</div>
...
<p class="caption">(\#fig:downloadQuartz-label)Downloading XQuartz</p>
</div>
...
<p class="caption">(\#fig:downloadWindowsR-label)Downloading R from the CRAN</p>
</div>
...
<p class="caption">(\#fig:downloadRstudio-label)Downloading R Studio (step 1)</p>
</div>
...
<p class="caption">(\#fig:downloadRstudio2-label)Downloading R Studio (step 2)</p>
</div>
...
<p class="caption">(\#fig:checkPackage-label)Checking package download</p>
</div>
