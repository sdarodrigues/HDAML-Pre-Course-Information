...
```{r, echo=FALSE, macCheck-label ,fig.cap="Mac MySQL Check", out.width = '100%'}
...
```{r, echo=FALSE, windowsCheck-label,fig.cap="Windows MySQL Check", out.width = '100%'}
...
```{r, echo=FALSE, DBeaverFree-label  ,fig.cap="DBeaver Free vs Paid", out.width = '100%'}
...
```{r, echo=FALSE, DBeaverInstallation-label ,fig.cap="Installation DBeaver on Mac", out.width = '100%'}
...
```{r, echo=FALSE, DBeaverView-label, fig.cap="What DBeaver Looks Like", out.width = '100%'}
...
```{r, echo=FALSE, SQLiteDriver-label ,fig.cap="Downloading SQLite Driver File", out.width = '100%'}
...
```{r, echo=FALSE, DBeaverScript-label, fig.cap="DBeaver New Script", out.width = '100%'}
...
```{r, echo=FALSE, FirstCommand-label ,fig.cap="Running SQL Commands", out.width = '100%'}
