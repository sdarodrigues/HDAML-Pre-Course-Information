...
```{r, echo=FALSE, downloadR-label, fig.cap="Downloading R from the CRAN", out.width = '100%'}
...
```{r, echo=FALSE, installR-label, fig.cap="R installation", out.width = '100%'}
...
```{r, echo=FALSE, downloadQuartz-label, fig.cap="Downloading XQuartz", out.width = '100%'}
...
```{r, echo=FALSE, downloadWindowsR-label ,fig.cap="Downloading R from the CRAN", out.width = '100%'}
...
```{r, echo=FALSE, downloadRstudio-label, fig.cap="Downloading R Studio (step 1)", out.width = '100%'}
...
```{r, echo=FALSE, downloadRstudio2-label, fig.cap="Downloading R Studio (step 2)", out.width = '100%'}
...
```{r, echo=FALSE, checkPackage-label, fig.cap="Checking package download", out.width = '100%'}
